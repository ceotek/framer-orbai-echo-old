      ...
      <div className="container-max">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            <Card key={index} className="bg-gradient-card border-border shadow-soft hover:shadow-medium transition-shadow duration-300">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              ...
              <Badge variant={stat.type === "before" ? "secondary" : "default"}>
        ...
        {/* Sync Section */}
        <Card className="bg-gradient-card border-border shadow-medium mb-16">
