      ...
      <div className="container-max relative z-10 max-w-full">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-row gap-3 sm:gap-6 justify-center mb-12 sm:mb-16 px-4 max-w-full">
            <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 px-6 sm:px-12 py-4 h-14 text-sm sm:text-base font-medium shadow-depth hover:shadow-ultra transform hover:-translate-y-1 transition-all duration-300 border-0 rounded-2xl flex-1 max-w-[200px] sm:min-w-[240px] sm:w-auto">
              Get Template
